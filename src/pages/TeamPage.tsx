...
import { Plus, Search, Eye, Edit, Trash2, UserPlus, Users, Shield, Building2, Package, MapPin, Truck, Navigation, Clock, Phone } from 'lucide-react';
...
const mockCustomers: Customer[] = [
  { id: '1', name: 'Rajesh Kumar', email: 'rajesh@email.com', phone: '+91 9876543220', totalOrders: 45, totalSpent: 28500, walletBalance: 250, membershipPlan: 'Premium', isActive: true, createdAt: '2023-06-15' },
  { id: '2', name: 'Priya Sharma', email: 'priya.s@email.com', phone: '+91 9876543221', totalOrders: 23, totalSpent: 15200, walletBalance: 100, isActive: true, createdAt: '2023-08-20' },
  { id: '3', name: 'Arun Patel', email: 'arun.p@email.com', phone: '+91 9876543222', totalOrders: 12, totalSpent: 8900, walletBalance: 0, isActive: true, createdAt: '2023-10-05' },
...
export function TeamPage() {
  ...
  const tabs = [
    ...
    { id: 'customers', label: 'Customers', icon: UserPlus, count: mockCustomers.length },
  ...
  const getModuleIcon = (moduleType: string) => {
    return moduleType === 'hub' ? Building2 : MapPin;
  };
  ...
  const filteredTeam = filteredTeamData.filter(member => {
    ...
    const matchesModule = !moduleFilter || member.moduleType === moduleFilter;
                ...
                {filteredTeam.map(member => {
                  ...
                  return (
                    <tr key={member.id} className="hover:bg-gray-50">
                      ...
                      <Td>
                        <Badge variant={getStatusColor(member.isActive ? 'active' : 'inactive')}>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Input 
                ...
                type="number"
                defaultValue={selectedCustomer.walletBalance}
                placeholder="0" 
              />
              
              <select 
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                defaultValue={selectedCustomer.membershipPlan || ''}
              >
            ...
            <div className="flex gap-3 pt-4">
              ...
              <Button 
                onClick={() => {
                  console.log('Update customer:', selectedCustomer.id);
                  setShowEditModal(false);
                  setSelectedCustomer(null);
                }}
                className="flex-1"
