...
import { Fish, Store, Calendar, Clock } from 'lucide-react';
...
const mockHubProducts: Product[] = [
  ...
  },
  {
    ...
    images: [],
    variants: [
      { id: 'rv2', type: 'Live', size: 'Large', grossWeight: '800-1000g', netWeight: '800-1000g', pieces: '1 piece', serves: '3-4', price: 1800, stock: 3 },
    ],
    isBestSeller: false,
    isRare: true,
    isActive: true,
...
const mockStoreProducts: Product[] = [
  ...
  },
  {
    ...
    images: [],
    variants: [
      { id: 'v7', type: 'Fresh', size: 'Medium', grossWeight: '12 pieces', netWeight: '12 pieces', pieces: '12 pieces', serves: '4-6', price: 120, stock: 100 },
    ],
    isBestSeller: true,
    isRare: false,
    isActive: true,
          ...
          {activeTab === 'hub' && (
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200 mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-blue-900">Hub Pre-Order Creation</h3>
                  <p className="text-sm text-blue-700">Fish products • Rare items • Advance booking • Next day delivery</p>
                </div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white/60 rounded-lg p-3">
                  <p className="text-2xl font-bold text-blue-900">{mockHubProducts.length}</p>
          ...
          {activeTab === 'store' && (
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200 mb-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-green-900">Store Pre-Order Creation</h3>
                  <p className="text-sm text-green-700">All products • Bulk orders • Subscriptions • Same/Next day delivery</p>
                </div>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white/60 rounded-lg p-3">
                  <p className="text-2xl font-bold text-green-900">{mockStoreProducts.length}</p>
