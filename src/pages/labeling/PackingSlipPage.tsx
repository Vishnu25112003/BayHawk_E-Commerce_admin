...
import { Package, Save, Settings, FileText } from "lucide-react";
...
export function PackingSlipPage() {
  ...
  const [activeTemplateId, setActiveTemplateId] = useState("default-packing");
  const [currentFields, setCurrentFields] = useState<SlipField[]>(defaultPackingFields);
    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold">Packing Slip Templates</h1>
            <p className="text-gray-600">Create and manage packing slip templates</p>
          </div>
        </div>
      ...
      {showTemplateManager && (
        <TemplateManager
          templates={templates.filter(t => t.type === 'packing')}
        ...
        <Card>
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Configure packing slip fields</p>
            </div>
          </div>
