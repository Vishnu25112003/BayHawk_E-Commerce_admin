        ...
        {selectedCustomer && activeTab === 'customers' && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Input 
                label="Secondary Phone (Optional)" 
                defaultValue={selectedCustomer.secondaryPhone}
                placeholder="+91 9876543210" 
              />
            </div>
            ...
            <div className="border-t pt-4 mt-4">
              ...
              <Input 
                label="Address Line 1" 
                placeholder="Street address, building name" 
                defaultValue={selectedCustomer.addresses?.[0]?.line1}
              />
              <Input 
                label="Address Line 2 (Optional)" 
                placeholder="Apartment, suite, floor" 
                defaultValue={selectedCustomer.addresses?.[0]?.line2}
                className="mt-3"
              />
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-3">
                <Input 
                  label="City" 
                  placeholder="City" 
                  defaultValue={selectedCustomer.addresses?.[0]?.city}
                />
                <Input 
                  label="State" 
                  placeholder="State" 
                  defaultValue={selectedCustomer.addresses?.[0]?.state}
                />
                <Input 
                  label="Pincode" 
                  placeholder="600001" 
                  defaultValue={selectedCustomer.addresses?.[0]?.pincode}
                />
              </div>
              <select 
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 mt-3"
                defaultValue={selectedCustomer.addresses?.[0]?.type || 'home'}
              >
