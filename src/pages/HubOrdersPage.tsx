...
const mockOrders: Order[] = [
  {
    ...
    items: [
      { productId: 'P001', productName: 'Fresh Pomfret', variant: '500g', quantity: 2, price: 450 }
    ],
    totalAmount: 900,
  ...
  },
  {
    ...
    paymentMethod: 'cod',
    items: [
      { productId: 'P002', productName: 'Chicken Breast', variant: '1kg', quantity: 1, price: 280 }
    ],
    totalAmount: 280,
...
export default function HubOrdersPage() {
  ...
  const filteredOrders = filterDataByModule(mockOrders, user).filter((order: Order) => {
