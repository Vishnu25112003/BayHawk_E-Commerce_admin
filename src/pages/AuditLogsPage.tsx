...
const mockLogs: AuditLog[] = [
  ...
  },
  {
    ...
    module: 'Products',
    details: 'Permanently deleted product "Expired Tuna - 1kg" from inventory due to quality issues',
    ipAddress: '192.168.1.1',
  ...
  },
  {
    ...
    details: 'Added new team member "Senthil Kumar" with role "Packing Employee"',
  ...
  },
  {
    ...
    module: 'Inventory',
    details: 'Received new stock: King Fish - 2kg, quantity: 100 pieces from supplier ABC Fisheries',
  ...
  },
  {
    ...
    action: 'Order Packed',
    module: 'Orders',
    details: 'Successfully packed order ORD-2024-002 with 3 items for customer Priya Sharma',
  ...
  },
  {
    ...
    module: 'Settings',
    details: 'Modified delivery time slots: Added new slot 7:00 PM - 9:00 PM for weekend deliveries',
    ipAddress: '192.168.1.3',
  ...
  },
  {
    ...
    action: 'Bulk Update',
    module: 'Products',
    details: 'Bulk price update applied to 25 fish products - increased prices by 5% due to market changes',
    ipAddress: '192.168.1.1',
  ...
  },
  {
    ...
    module: 'Orders',
    details: 'Cancelled order ORD-2024-003 due to customer request - refund initiated',
  ...
  },
  {
    ...
    module: 'Suppliers',
    details: 'Added new supplier "Fresh Ocean Traders" with contact details and product categories',
  ...
  },
  {
    ...
    module: 'System',
    details: 'Initiated daily system backup - all data successfully backed up to cloud storage',
    ipAddress: '192.168.1.2',
  ...
  },
  {
    ...
    details: 'Performed quality check on incoming stock - rejected 5kg of Mackerel due to freshness issues',
  ...
  },
  {
    ...
    module: 'Delivery',
    details: 'Optimized delivery route for 8 orders in Sector 15 area - estimated time saved: 45 minutes',
  ...
  },
  {
    ...
    module: 'Marketing',
    details: 'Created weekend special promotion: 20% off on all Pomfret varieties',
    ipAddress: '192.168.1.3',
  ...
  },
  {
    ...
    details: 'Recorded customer feedback for order ORD-2024-004 - 5-star rating with positive comments',
  ...
  },
  {
    ...
    module: 'Security',
    details: 'Applied security patch v2.1.3 - enhanced password encryption and session management',
    ipAddress: '192.168.1.1',
...
export default function AuditLogsPage() {
  ...
  if (!hasPermission(user, PERMISSIONS.HUB_AUDIT_LOGS) && !hasPermission(user, PERMISSIONS.STORE_TEAM_MANAGE)) {
    return (
              ...
              {filteredLogs.map((log) => {
                ...
                return (
                  <tr key={log.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4">
                      <Badge className={moduleColors[log.module as keyof typeof moduleColors] || 'bg-gray-100 text-gray-800'}>
                        {log.module}
                      </Badge>
                    </td>
                    <td className="px-6 py-4">
                      <p className="text-sm text-gray-900 max-w-md truncate" title={log.details}>
                        {log.details}
                      </p>
                    </td>
                    <td className="px-6 py-4">
