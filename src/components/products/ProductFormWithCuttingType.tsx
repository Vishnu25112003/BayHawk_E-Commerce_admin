              ...
              <div className="grid gap-3 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => handleVariantChange(index, 'cuttingTypeId', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                  >
                    <option value="">Select Cutting Type</option>
                    {getCuttingTypesForCategory(formData.category).map(type => (
                      <option key={type.id} value={type.id} title={type.description}>
                        {type.name} - {type.description}
                      </option>
                    ))}
                  </select>
                  {variant.cuttingTypeId && (
                    <div className="mt-2 p-2 bg-blue-50 rounded border text-xs">
                      {(() => {
                        const selectedType = getCuttingTypesForCategory(formData.category).find(t => t.id === variant.cuttingTypeId);
                        return selectedType ? (
                          <div className="flex gap-2">
                            ...
                            <div>
                              <p className="font-medium text-blue-800">{selectedType.name}</p>
                              <p className="text-blue-600">{selectedType.description}</p>
                            </div>
                          </div>
                        ) : null;
                      })()}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleVariantChange(index, 'grossWeight', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleVariantChange(index, 'netWeight', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleVariantChange(index, 'serves', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
