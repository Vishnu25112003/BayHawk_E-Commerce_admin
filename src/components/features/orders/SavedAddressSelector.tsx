              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <Badge variant={addressTypeColors[selectedAddress.type] as any}>
      ...
      >
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg">
            ...
            {[
              { value: 'all', label: 'All', count: savedAddresses.length },
              { value: 'home', label: 'Home', count: savedAddresses.filter(addr => addr.type === 'home').length },
              { value: 'work', label: 'Work', count: savedAddresses.filter(addr => addr.type === 'work').length },
              { value: 'other', label: 'Others', count: savedAddresses.filter(addr => addr.type === 'other').length }
            ].map((filter) => (
              <button
                key={filter.value}
                type="button"
                      ...
                      <div className="flex items-start gap-3 flex-1">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <Badge variant={addressTypeColors[address.type] as any}>
                              {address.type}
                            </Badge>
                            {address.isDefault && (
                              <Badge variant="success">Default</Badge>
