...
import { sampleProducts, sampleHubs } from '../../../utils/sampleProducts';
...
export function ManualOrderForm({ moduleType, products = sampleProducts, hubs = sampleHubs, onSubmit }: ManualOrderFormProps) {
  ...
  const handleCustomerSearch = (phone: string) => {
    ...
    if (phone === '+919876543210') {
      ...
      setValue('customerSecondaryPhone', mockCustomer.secondaryPhone || '');
                ...
                {[
                  ...
                  <label key={type.value} className="flex items-center gap-2">
                    <input
                      ...
                      onChange={(e) => {
                        setValue('addressType', e.target.value as any);
        ...
        <Card>
          ...
          <div className="mt-6">
            <PaymentStatusSelector
              ...
              totalAmount={total}
              onPaymentStatusChange={(status) => setValue('paymentStatus', status as any)}
