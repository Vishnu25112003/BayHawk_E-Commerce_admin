                        ...
                        <div key={reward.id} className="bg-white border rounded-lg p-3 space-y-3">
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            <Input 
                              ...
                              type="number" 
                              placeholder="0"
                              value={reward.minCartValue || ''}
                              onChange={(e) => updateReward(slab.id, reward.id, 'minCartValue', e.target.value ? Number(e.target.value) : undefined)}
                            />
                            <Input 
                              label="Reward Value" 
                              type="number" 
                              ...
                              onChange={(e) => updateReward(slab.id, reward.id, 'rewardValue', e.target.value ? Number(e.target.value) : undefined)}
                            />
                          </div>
